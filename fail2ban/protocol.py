...
protocol = [
    ...
    ["restart [--unban] [--if-exists] <JAIL>", "restarts the jail <JAIL> (alias for "
                                               "'reload --restart ... <JAIL>')"],
    ["reload [--restart] [--unban] [--all]",
     "reloads the configuration without restarting of the server, the option '--restart' "
     "activates completely restarting of affected jails, thereby can unban IP addresses "
     "(if option '--unban' specified)"],
    ...
    ["set <JAIL> action <ACT> actionstart <CMD>", "sets the start command <CMD> of the "
     "action <ACT> for <JAIL>"],
    ["set <JAIL> action <ACT> actionstop <CMD>", "sets the stop command <CMD> of the "
     "action <ACT> for <JAIL>"],
    ["set <JAIL> action <ACT> actioncheck <CMD>", "sets the check command <CMD> of the "
     "action <ACT> for <JAIL>"],
    ["set <JAIL> action <ACT> actionban <CMD>", "sets the ban command <CMD> of the "
     "action <ACT> for <JAIL>"],
    ["set <JAIL> action <ACT> actionunban <CMD>", "sets the unban command <CMD> of the "
     "action <ACT> for <JAIL>"],
    ["set <JAIL> action <ACT> timeout <TIMEOUT>",
     "sets <TIMEOUT> as the command timeout in seconds for the action <ACT> for <JAIL>"],
    ["", "GENERAL ACTION CONFIGURATION", ""],
    ["set <JAIL> action <ACT> <PROPERTY> <VALUE>", "sets the <VALUE> of <PROPERTY> "
    ...
    ["get <JAIL> failregex", "gets the list of regular expressions which matches "
     "the failures for <JAIL>"],
    ["get <JAIL> ignoreregex", "gets the list of regular expressions which matches "
     "patterns to ignore for <JAIL>"],
    ["get <JAIL> findtime", "gets the time for which the filter will look back for "
     "failures for <JAIL>"],
    ["get <JAIL> bantime", "gets the time a host is banned for <JAIL>"],
    ["get <JAIL> datepattern", "gets the patern used to match date/times for <JAIL>"],
    ["get <JAIL> usedns", "gets the usedns setting for <JAIL>"],
    ["get <JAIL> banip [<SEP>|--with-time]",
     "gets the list of of banned IP addresses for <JAIL>. Optionally the separator "
     "character ('<SEP>', default is space) or the option '--with-time' (printing "
     "the times of ban) may be specified. The IPs are ordered by end of ban."],
    ["get <JAIL> maxretry", "gets the number of failures allowed for <JAIL>"],
    ["get <JAIL> maxmatches", "gets the max number of matches stored in memory "
     "per ticket in <JAIL>"],
    ...
    ["get <JAIL> action <ACT> actionunban", "gets the unban command for the "
     "action <ACT> for <JAIL>"],
    ["get <JAIL> action <ACT> timeout", "gets the command timeout in seconds "
     "for the action <ACT> for <JAIL>"],
    ["", "GENERAL ACTION INFORMATION", ""],
    ["get <JAIL> actionproperties <ACT>", "gets a list of properties for the "
     "action <ACT> for <JAIL>"],
    ["get <JAIL> actionmethods <ACT>", "gets a list of methods for the action "
     "<ACT> for <JAIL>"],
