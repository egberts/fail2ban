...
# [Sun Jul 28 21:27:56.549667 2013] [auth_digest:error] [pid 24835:tid
# 139895297222400] [client 127.0.0.1:57052] AH01788: realm mismatch - g
# ot `so far away' but expected `digest private area'
...
# [Sun Jul 28 21:41:20 2013] [error] [client 127.0.0.1] Digest: unknown
# algorithm `super funky chicken' received: /digest/
...
# [Sun Jul 28 21:05:31.178340 2013] [auth_digest:error] [pid 24224:tid
# 139895539455744] [client 127.0.0.1:56906] AH01793: invalid qop `auth'
# received: /digest/qop_none/
...
# [client 127.0.0.1:56964] AH01776: invalid nonce b9YAiJDiBAZZZ1b1abe02d20063ea3b16b544
# ea1b0d981c1bafe received - hash is not d42d824dee7aaf50c3ba0a7c6290bd453e3dd35b
...
r = auth(v)
# [Mon Jul 29 02:12:55.539813 2013] [auth_digest:error] [pid 9647:tid
# 139895522670336] [client 127.0.0.1:58474] AH01777: invalid nonce 59QJppTiBAA=
# b08983fd166ade9840407df1b0f75b9e6e07d88d received - user attempted time travel
print(r.status_code, r.headers, r.text)
