...
source_dir = os.path.realpath(os.path.dirname(
    # __file__ seems to be overwritten sometimes on some python
    # versions (e.g. bug of 2.6 by running under cProfile, etc.):
...
class InstallScriptsF2B(install_scripts):
...
class InstallCommandF2B(install):
...
setup(
    ...
    cmdclass={
        ...
        'install_scripts': InstallScriptsF2B, 'install': InstallCommandF2B
    },
    scripts=[
        'bin/fail2ban-client',
        'bin/fail2ban-server',
